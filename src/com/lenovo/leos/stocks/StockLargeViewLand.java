...
public class StockLargeViewLand extends StockLargeView implements StockConstants {

	public static String TAG = "StockLargeViewLand";
...
//	private EditText edit;
	...
	public StockLargeViewLand(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub
	}

	public StockLargeViewLand(Context context, int widgetId) {
		super(context);
		// TODO Auto-generated constructor stub
	...
	public StockLargeViewLand(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		cResource = context.getContentResolver();
		mContext = context;
	...
	public void SetInitView() {
		largeview = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.stocklist_widget_large, null);
		...
		stocklist 		= (ListView) largeview.findViewById(R.id.stock_list);
...
//		largeview.postInvalidate();
		...
		Log.d(TAG, "SelectStock 111="+SelectStock);
		if(SelectStock == null) {
	...
	private void onClickItemViewRefreshBtn(String stockerCode) {
		StockLargeViewLand.stockerEnvelop.clearTempInfo();
		...
		if(stockerCode != null) {
			...
			if(isConnected) {
				...
				StockLargeViewLand.stockerEnvelop.stockInfoTimestamp = timeStamp;
...
//		stock_list_item_view.postInvalidate();
		...
		if (mItemStockerCode != null) {
			...
			Bitmap bitmap = StockLargeViewLand.stockerEnvelop.getMStockerBitMap(ImagestockCode);
			String ImagestockName = StockLargeViewLand.stockerEnvelop.getMStockerName(ImagestockCode);
			if (bitmap != null && ImagestockName != null) {
				Bitmap mBitmap = Bitmap.createScaledBitmap(bitmap, 343, 147, true);
				Image.setImageBitmap( mBitmap);
			}
		}
		String nullTag = mContext.getResources().getString(R.string.nullTag);
		String stockCode = mItemStockerCode;
		String stockName = StockLargeViewLand.stockerEnvelop.getMStockerName(stockCode);
		...
		updateStockTime.setText(mContext.getResources().getString(R.string.timeTitle) + " " + nullTag);
		mOpen.setText(mContext.getResources().getString(R.string.close));
		mJinkai.setText((StockLargeViewLand.stockerEnvelop.sStockerJinkai==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerJinkai));
		mZuigao.setText((StockLargeViewLand.stockerEnvelop.sStockerZuigao==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZuigao));
		mZuidi.setText((StockLargeViewLand.stockerEnvelop.sStockerZuidi==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZuidi));
		mChengjiaoliang.setText( (StockLargeViewLand.stockerEnvelop.sStockerChengjiaoliang==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerChengjiaoliang));
		mZuoshou.setText( (StockLargeViewLand.stockerEnvelop.sStockerZuoshou==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZuoshou));
		mZuixin.setText((StockLargeViewLand.stockerEnvelop.sStockerZuixin==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZuixin));
		mZhangdiefu.setText((StockLargeViewLand.stockerEnvelop.sStockerZhangdiefu==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZhangdiefu));
		mZhangdiee.setText((StockLargeViewLand.stockerEnvelop.sStockerZhangdiee==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZhangdiee));
		mChengjiaoe.setText((StockLargeViewLand.stockerEnvelop.sStockerChengjiaoe==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerChengjiaoe));

		if(mItemStockerCode != null && stockName != null) {
			stockerItemName.setText(stockName);
			String stockTime =  StockLargeViewLand.stockerEnvelop.mStockerUpdateTime;
			...
			mZuoshou.setText( (StockLargeViewLand.stockerEnvelop.sStockerZuoshou==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZuoshou));
			mZuixin.setText((StockLargeViewLand.stockerEnvelop.sStockerZuixin==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZuixin));
			stockerTopZX.setText((StockLargeViewLand.stockerEnvelop.sStockerZuixin==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZuixin));
			String zdf = StockLargeViewLand.stockerEnvelop.sStockerZhangdiefu==null?nullTag:StockLargeViewLand.stockerEnvelop.sStockerZhangdiefu;
			...
			String city = StockLargeViewLand.stockerEnvelop.getMStockerStype(mItemStockerCode);
			if(city != null && city.equals("gn")) {
				String tempcity=StockLargeViewLand.stockerEnvelop.getMStockerCity(mItemStockerCode);
			...
			if(StockLargeViewLand.stockerEnvelop.sOpen != null
					&& StockLargeViewLand.stockerEnvelop.sOpen.equals(STATUS_OPEN)) {
				mOpen.setText( mContext.getResources().getString(R.string.open1));
			} else if (StockLargeViewLand.stockerEnvelop.sOpen != null
					&& StockLargeViewLand.stockerEnvelop.sOpen.equals(STATUS_SUSPENSION)) {
    	...
    	if (selecedStockerCodeAndValues != null
			...
			for (int i = 0; i < n; i++) {
				if (codesAndValues[i] != null
					...
					Log.i("list", "init "+i+" "+selectindex[i]+" "+names[i]);
					}
			}
    	}
...
//		}
			...
			stocklist.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Log.i("list", "position= "+position+" SelectStock="+SelectStock);
...
//		viewgroup.postInvalidate();
	...
	private int getRefreshId() {
		String stockType = StockLargeViewLand.stockerEnvelop.getMStockerStype(mItemStockerCode);
		if (stockType != null
		...
		if (selecedStockerCodeAndValues != null
			...
			for (int i = 0; i < n; i++) {
				if (codesAndValues[i] != null
					...
					StockLargeViewLand.stockerEnvelop.putMStockerName(code, names[i]);
					StockLargeViewLand.stockerEnvelop.setMStockerZuixin(code, zuixins[i]);
					StockLargeViewLand.stockerEnvelop.setMStockerZhangdiee(code, zhangdiees[i]);
					StockLargeViewLand.stockerEnvelop.setMStockerZhangdiefu(code, zhangdiefus[i]);
					StockLargeViewLand.stockerEnvelop.setMChengjiaoliang(code, chengjiaoliangs[i]);
				}
			}
	...
	void startFetchStocker(Context context) {
		...
		if (selectedCodeAndValue != null
			...
			for (int i = 0; i < SPECIFIED_STOCKS.length; i++) {
				StockLargeViewLand.stockerEnvelop.stockInfoTimestamp = -1L;
	...
	private void fetchImage(String imageUrl, String itemCode, int refreshID) {
		long timestamp;
		StockLargeViewLand.stockerEnvelop.mImageType = refreshID;
		StockLargeViewLand.stockerEnvelop.currentImageUrl = imageUrl;
		if (itemCode != null
				&& !"".equals(itemCode.trim())) {
			if(getNetConnectState(mContext)){
				timestamp = System.currentTimeMillis();
				StockLargeViewLand.stockerEnvelop.imageTimestamp = timestamp;
	...
	public void fetchImage() {
		String imageUrl = StockLargeViewLand.stockerEnvelop.currentImageUrl;
		int refreshId = StockLargeViewLand.stockerEnvelop.mImageType;
		long timeStamp = System.currentTimeMillis();
		StockLargeViewLand.stockerEnvelop.stockInfoTimestamp = timeStamp;
	...
	private String getImageUrlWithRefreshId(int type, int refreshId, String itemCode) {
		...
		if (refreshId == -1) {
			switch (type) {
			case TYPE_US:
				ret = StockLargeViewLand.stockerEnvelop.getMStockerDayImage(itemCode);
				break;
			case TYPE_FUND:
				ret = StockLargeViewLand.stockerEnvelop.getMStockerCurrImage(itemCode);
				break;
			default:
				ret = StockLargeViewLand.stockerEnvelop.getMStockerTimeImage(itemCode);
				break;
			}
		...
		case SHOW_GN_DAY_K_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.mDayKImage;
			break;
		case SHOW_GN_WEEK_K_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.mWeekKImage;
			break;
		case SHOW_GN_MONTH_K_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.mMonthKImage;
			break;
		case SHOW_US_ONE_DAY_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.getMStockerDayImage(itemCode);
			break;
		case SHOW_US_ONE_MONTH_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.mOneMonthImage;
			break;
		case SHOW_US_THREE_MONTH_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.mThreeMonthImage;
			break;
		case SHOW_US_ONE_YEAR_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.mOneYearImage;
			break;
		case SHOW_FUND_CURRENT_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.getMStockerCurrImage(itemCode);
			break;
		case SHOW_FUND_HISTORY_IMAGE:
			ret = StockLargeViewLand.stockerEnvelop.mHistoryImage;
			break;
		default:
			ret = StockLargeViewLand.stockerEnvelop.getMStockerTimeImage(itemCode);
			break;
...
//		Bitmap bmp = BitmapFactory.decodeResource(getResources(), R.drawable.list);
...
//				String codeAndType = StockLargeViewLand.stockerEnvelop.getMStockerCodeAndType(itemCode);
...
//				SetInitView();
		...
		View.OnClickListener lZhangdiefu = new OnClickListener() {
    		...
    		public void onClick(View view) {
				...
				StockLargeViewLand.stockerEnvelop.currentVolume = SELECTED_COLUMN_RATIO;
		...
		View.OnClickListener lZhangdiee = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				initStocktListView();
	     		...
	     		StockLargeViewLand.stockerEnvelop.currentVolume = SELECTED_COLUMN_CHANGE;
	     		mTimeoutHandler.sendEmptyMessage(FETCHSTOCKER_ID_TIMEOUT);
	     	}
		};
		...
		View.OnClickListener lChengjiaoliang = new OnClickListener() {
			...
			public void onClick(View view) {
				...
				StockLargeViewLand.stockerEnvelop.currentVolume = SELECTED_COLUMN_VOLUME;
				mTimeoutHandler.sendEmptyMessage(FETCHSTOCKER_ID_TIMEOUT);
			}
		};
		...
		if (StockLargeViewLand.stockerEnvelop.mStockerSystemTime != null) {
			textTime.setText(StockLargeViewLand.stockerEnvelop.mStockerSystemTime);
		}
	}
...
//			Chengjiaoliang.setTextColor(R.color.update_time);
	...
	public void startonclik(int positions) {
		...
		if(positions != 100){
			...
			for(int i=0;i<selecedStocke.length;i++)Log.i("list", i+"  "+selecedStocke[i]);
		...
		while (eventType != XmlPullParser.END_DOCUMENT) {
			if (eventType == XmlPullParser.START_TAG) {
				...
				if (tag.equals("stock")) {
					...
					StockLargeViewLand.stockerEnvelop.putMStockerCodeAndType(code,
...
//				String nullTag = mContext.getResources().getString(R.string.nullTag);
//				temp = StockLargeViewLand.stockerEnvelop.getMStockerName(stockerCode);
...
//
//				//最新价格
//				temp = StockLargeViewLand.stockerEnvelop.getMStockerZuixin(stockerCode);
...
//
//					temp = StockLargeViewLand.stockerEnvelop.getMStockerZhangdiefu(stockerCode);
//					if(temp == null || temp.equals("null")) {
//						temp = nullTag;
//					}
//					String st = temp;
...
//					mStockerValuesTextView.setVisibility(GONE);
//
//					temp = StockLargeViewLand.stockerEnvelop.getMStockerZhangdiee(stockerCode);
//					if(temp == null || temp.equals("null")) {
//						temp = nullTag;
//					}
//					String st = temp;
...
//					mStockerValuesTextView.setVisibility(View.VISIBLE);
//
//					temp = StockLargeViewLand.stockerEnvelop.getMChengjiaoliang(stockerCode);
//					if(temp == null || temp.equals("null")) {
//						temp = nullTag;
//					}
//					mStockerValuesTextView.setText(temp == null ? nullTag : temp);
...
//				}
			...
			StockLargeViewLand.stockerEnvelop.mStockerBitMap.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerChengjiaoliang.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerCodeAndType.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerCurrImage.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerDayImage.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerName.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerStype.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerTimeImage.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerZhangdiee.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerZhangdiefu.remove(code);
			StockLargeViewLand.stockerEnvelop.mStockerZuixin.remove(code);
...
//			CodesAndTypes=selectedCodeAndTypes=sh000001/1;sz399001/1;00992/5;
			...
			for(int i=0; i<delList.size(); i++){
				...
				codeAndValue = StockLargeViewLand.stockerEnvelop.getMStockerCodeAndType(code);
...
//					}
//					SelectStock = StockLargeViewLand.stockerEnvelop.getMStockerCodeAndType(selcodelist_add.get(selcodelist_add.size()-1).toString());
//				} else {
//					Cursor cursor = cResource.query(URI, null, FIRST_SELECED_CODES_AND_TYPES_XML, null, WidgetId+NULLSTRING);
//					String[] temp = null;
//					if(cursor.moveToFirst()) {
...
//				mContext.sendBroadcast(new Intent(INTENT_FINISH));
				...
				INDEX = 1;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mTimeImage
						, mItemStockerCode
						, SHOW_GN_TIMES_IMAGE);
			} else if(v.getId() == R.id.dayk) {
				INDEX = 2;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mDayKImage
						, mItemStockerCode
						, SHOW_GN_DAY_K_IMAGE);
			} else if(v.getId() == R.id.weekk) {
				INDEX = 3;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mWeekKImage
						, mItemStockerCode
						, SHOW_GN_WEEK_K_IMAGE);
			} else if(v.getId() == R.id.monthk) {
				INDEX = 4;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mMonthKImage
						, mItemStockerCode
						, SHOW_GN_MONTH_K_IMAGE);
			} else if(v.getId() == R.id.oneday) {
				INDEX = 1;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mDayImage
						, mItemStockerCode
						, SHOW_US_ONE_DAY_IMAGE);
			} else if(v.getId() == R.id.onemonth) {
				INDEX = 2;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mOneMonthImage
						, mItemStockerCode
						, SHOW_US_ONE_MONTH_IMAGE);
			} else if(v.getId() == R.id.threemonth) {
				INDEX = 3;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mThreeMonthImage
						, mItemStockerCode
						, SHOW_US_THREE_MONTH_IMAGE);
			} else if(v.getId() == R.id.oneyear) {
				INDEX = 4;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mOneYearImage
						, mItemStockerCode
						, SHOW_US_ONE_YEAR_IMAGE);
			} else if(v.getId() == R.id.curr) {
				INDEX = 5;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mCurrentImage
						, mItemStockerCode
						, SHOW_FUND_CURRENT_IMAGE);
			} else if(v.getId() == R.id.history) {
				INDEX = 6;
				updateStockItem();
				fetchImage(StockLargeViewLand.stockerEnvelop.mHistoryImage
						, mItemStockerCode
...
//					Log.d("zz", "handleMessage  FETCHSTOCKER_INFO_TIMEOUT finish="+finish+" REMIN="+REMIN);
					...
					if (finish != DONNOT_SAVE || StockLargeViewLand.stockerEnvelop.isItem) {
						if(StockLargeViewLand.REMIN == 1) {
							updateStockItem();
						} else if(StockLargeViewLand.REMIN == 2) {
							StockLargeViewLand.refreshList = true;
							updateStaticStockerInfo();
						}
					}
					Intent intent = new Intent(INTENT_NAME);
					if(StockLargeViewLand.REMIN == 1 && fetching){
						fetching = false;
						updateStockItem();
						fetchImage();
					}
		...
		public void run() {
			if (mTimestamp == -1 && mValues != null) {
				...
				if (StockLargeViewLand.stockerEnvelop.isItem) {
					return;
				}
			} else {
				// To get stock info
				...
				long timestamp = StockLargeViewLand.stockerEnvelop.stockInfoTimestamp;
				if (timestamp != -1
						&& timestamp != this.mTimestamp
						&& StockLargeViewLand.stockerEnvelop.isItem) {
					return;
				}
			}
...
//						+ System.currentTimeMillis());
				...
				if (!parseResult) {
					...
					if (putTask) {
						...
						StockerEnvelop.fetchSynch.putTaskData(mSearchCode,
								...
								+ VALUE_VALUE_SEPERATOR + nullTag
								+ VALUE_VALUE_SEPERATOR + nullTag);
						StockLargeViewLand.stockerEnvelop.putMStockerName(code, stockName);
						StockLargeViewLand.stockerEnvelop.setMStockerZuixin(code, nullTag);
						StockLargeViewLand.stockerEnvelop.setMStockerZhangdiee(code, nullTag);
						StockLargeViewLand.stockerEnvelop.setMStockerZhangdiefu(code, nullTag);
						StockLargeViewLand.stockerEnvelop.setMChengjiaoliang(code, nullTag);
				...
				while (eventType != XmlPullParser.END_DOCUMENT) {
					if (eventType == XmlPullParser.START_TAG) {
						...
						if (tag.equals("stock")) {
							...
							StockLargeViewLand.stockerEnvelop.putMStockerName(mStockerCode, mStockerName);
						} else if (tag.equals("stype")) {
							xpp.next();
							stype = xpp.getText();
							StockLargeViewLand.stockerEnvelop.putMStockerStype(mStockerCode, stype == null ? null : stype.trim());
						} else if (tag.equals("city")) {
							xpp.next();
							city = xpp.getText();
							StockLargeViewLand.stockerEnvelop.putMStockerCity(mStockerCode, city == null ? null : city.trim());
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.sStockerZuixin = formatStr;
							}
							StockLargeViewLand.stockerEnvelop.setMStockerZuixin(mStockerCode, formatStr);
							...
							StockLargeViewLand.stockerEnvelop.setMStockerZhangdiee(mStockerCode, formatStr);
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.sStockerZhangdiee = formatStr;
							}
							...
							StockLargeViewLand.stockerEnvelop.setMStockerZhangdiefu(mStockerCode, formatStr);
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.sStockerZhangdiefu = formatStr;
							}
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.sStockerChengjiaoliang = formatStr;
							}
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								...
								StockLargeViewLand.stockerEnvelop.sStockerZuoshou = formatStr;
							}
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								...
								StockLargeViewLand.stockerEnvelop.sStockerJinkai = formatStr;
							}
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								...
								StockLargeViewLand.stockerEnvelop.sStockerZuidi = formatStr;
							}
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								...
								StockLargeViewLand.stockerEnvelop.sStockerZuigao = formatStr;
							}
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								...
								StockLargeViewLand.stockerEnvelop.sStockerChengjiaoe = formatStr;
							}
							...
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								if (!(zuixin != null && zuixin.equals(INVALID_VALUE)) && tmp != null && !INVALID_VALUE.equals(tmp)) {
									StockLargeViewLand.stockerEnvelop.sOpen = tmp;
								} else {
									StockLargeViewLand.stockerEnvelop.sOpen = STATUS_SUSPENSION;
								}
							}
						} else if (tag.equals("time_image")) {
							xpp.next();
							tmp = (xpp.getText() == null ? null : xpp.getText().trim());
							StockLargeViewLand.stockerEnvelop.setMStockerTimeImage(mStockerCode, tmp);
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mTimeImage = tmp;
							}
						} else if (tag.equals("day_k_image")) {
							xpp.next();
							StockLargeViewLand.stockerEnvelop.mDayKImage = (xpp.getText() == null ? null : xpp.getText().trim());
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
							...
							xpp.next();
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mWeekKImage = (xpp.getText() == null ? null : xpp.getText().trim());
							}
						} else if (tag.equals("month_k_image")) {
							xpp.next();
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mMonthKImage = (xpp.getText() == null ? null : xpp.getText().trim());
							}
						} else if (tag.equals("day_image")) {
							xpp.next();
							tmp = (xpp.getText() == null ? null : xpp.getText().trim());
							StockLargeViewLand.stockerEnvelop.setMStockerDayImage(mStockerCode, tmp);
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mDayImage = tmp;
							}
						} else if (tag.equals("one_month_image")) {
							xpp.next();
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mOneMonthImage = (xpp.getText() == null ? null : xpp.getText().trim());
							}
						} else if (tag.equals("three_month_image")) {
							xpp.next();
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mThreeMonthImage = (xpp.getText() == null ? null : xpp.getText().trim());
							}
						} else if (tag.equals("one_year_image")) {
							xpp.next();
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mOneYearImage = (xpp.getText() == null ? null : xpp.getText().trim());
							}
						} else if (tag.equals("curr_image")) {
							xpp.next();
							tmp = (xpp.getText() == null ? null : xpp.getText().trim());
							StockLargeViewLand.stockerEnvelop.setMStockerCurrImage(mStockerCode, tmp);
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mCurrentImage = tmp;
							}
						} else if (tag.equals("history_image")) {
							xpp.next();
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mHistoryImage = (xpp.getText() == null ? null : xpp.getText().trim());
							}
						} else if (tag.equals("updatetime")) {
							xpp.next();
							if (this.mTimestamp != -1 && StockLargeViewLand.stockerEnvelop.stockInfoTimestamp == mTimestamp) {
								StockLargeViewLand.stockerEnvelop.mStockerUpdateTime = (xpp.getText() == null ? nullTag : xpp.getText().trim());
							}
	...
	public class FetchStockerImage extends Thread implements StockConstants {
		...
		public void run() {
			...
			long timestamp = StockLargeViewLand.stockerEnvelop.imageTimestamp;
		...
		private int fetch(String stockerUrl) {
			...
			try {
				// Clear stored bitmap
				StockLargeViewLand.stockerEnvelop.mStockerBitMap.clear();
				...
				StockLargeViewLand.stockerEnvelop.putMStockerBitMap(mStockerCode, bmImg);
			} catch (Exception e) {
				e.printStackTrace();
				if (DEBUG) {
